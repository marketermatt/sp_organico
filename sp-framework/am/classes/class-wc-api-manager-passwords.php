...
class API_Manager_Organico_theme_Password_Management {
	...
	private function rand( $min = 0, $max = 0 ) {
		...
		// Some misconfigured 32bit environments (Entropy PHP, for organico) truncate integers larger than PHP_INT_MAX to PHP_INT_MAX rather than overflowing them to floats.

...
class API_Manager_Organico_theme_MENU {

	private $api_manager_theme_organico_key;

	// Load admin menu
	public function __construct() {

		$this->api_manager_theme_organico_key = AMET()->api_manager_theme_organico_key;
	...
	public function replace_license_key( $current_api_key ) {
		...
		$reset = $this->api_manager_theme_organico_key->deactivate( $args ); // reset license key activation
	...
	public function wc_am_license_key_deactivation( $input ) {
		...
		// $activate_results = json_decode( $this->api_manager_theme_organico_key->status( $args ), true );
		...
		if ( $options == 'on' && $activation_status == 'Activated' && AMET()->ame_options[AMET()->ame_api_key] != '' && AMET()->ame_options[AMET()->ame_activation_email] != '' ) {
			...
			$activate_results = json_decode( $this->api_manager_theme_organico_key->deactivate( $args ), true );
...
new API_Manager_Organico_theme_MENU();

...
function _sp_custom_box_contact_form_settings( $post ) {
	...
	$output .= '<td class="col3"><p class="howto">' . __( 'Enter the email subject.', 'sp-theme' ) . '</p></td>' . PHP_EOL;
	$output .= '</tr>' . PHP_EOL;
...
function _sp_custom_box_contact_form_messages( $post ) {
	...
	$output .= '<tr>' . PHP_EOL;
	$output .= '<td class="col1">' . __( 'From Email', 'sp-theme' ) . ':</td>' . PHP_EOL;
	$output .= '<td class="col2"><input type="text" name="contact_form_from_email" value="' . esc_attr( $from_email ) . '" class="widefat" /></td>' . PHP_EOL;
	$output .= '<td class="col3"><p class="howto">' . __( 'Enter the email you would like to show in the email from section when receiving the email.', 'sp-theme' ) . '</p></td>' . PHP_EOL;
	$output .= '</tr>' . PHP_EOL;

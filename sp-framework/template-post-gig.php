											...
											<?php $count = 0; while (have_posts()) : the_post(); $count++; ?>
												...
												<div <?php post_class('actual_post') ?> id="post-<?php the_ID(); ?>">
													...
													<div class="post_entry">
														...
														<?php if(!isset($_REQUEST['job_id']) && $_REQUEST['job_id']==0) { ?>
														To post a gig and browse available Day Player profiles, upgrade to a free Employer membership (You will not lose access to your original Day Player account). You can do this by requesting an account through the link below:
														<br />

<a title="Request Account Change" href="/request-account-change/">Upgrade Your Account</a>
														<br />
														<?php } ?>
										...
										<?php if($level=='day-player-employer') { ?>	
													...
													<br />
													Your gig will be live for 60 days or until you delete it.
														<?php } ?>
...
<?php if(!isset($_REQUEST['job_id']) && $_REQUEST['job_id']==0) { ?>										
										<strong>Do not put any contact information in the description field. Excluding personal information is to protect your privacy. We are not responsible for any unwanted contact.</strong>
<?php } // if closed if job is submit ?>											
										<br />
										<?php echo do_shortcode('[submit_job_form]');?>
								<br />		
								Your gig will be live for 60 days or until you delete it.			

		...
		<div class="comment-author vcard">
            ...
            <div class="comment-meta commentmetadata">
                <?php
                    ...
                    printf( __('%1$s <br /> %2$s', 'sp'), get_comment_date(), get_comment_time()); ?><?php edit_comment_link( __('(Edit)', 'sp'), ' ' );
                ?>
...
function sp_posted_on() {
	printf( __( '<span class="calendar-icon">&nbsp;</span>%1$s <span class="meta-sep">by</span> %2$s', 'sp' ),
		sprintf( '<a href="%1$s" title="%2$s" data-rel="bookmark"><time pubdate datetime="%2$s" class="entry-date">%3$s</time></a>',
			get_permalink(),
			get_the_date('c'),
			get_the_date()
		),
...
function sp_posted_in() {
	...
	if ( $tag_list ) {
		$posted_in = __( '<span class="article-icon">&nbsp;</span>Posted in %1$s <span class="tag-icon">&nbsp;</span>Tags %2$s. <span class="bookmark-icon">&nbsp;</span>Bookmark the <a href="%3$s" title="Permalink to %4$s" data-rel="bookmark">permalink</a>', 'sp' );
	} elseif ( is_object_in_taxonomy( get_post_type(), 'category' ) ) {
		$posted_in = __( '<span class="article-icon">&nbsp;</span>Posted in %1$s. <span class="bookmark-icon">&nbsp;</span>Bookmark the <a href="%3$s" title="Permalink to %4$s" data-rel="bookmark">permalink</a>', 'sp' );
	} else {
		$posted_in = __( '<span class="bookmark-icon">&nbsp;</span>Bookmark the <a href="%3$s" title="Permalink to %4$s" data-rel="bookmark">permalink</a>', 'sp' );
	}

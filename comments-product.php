...
<?php comment_form(array('title_reply' => 'Leave a Review','comment_notes_after' => '','fields' => apply_filters( 'comment_form_default_fields', $fields ),'comment_field' => '<p class="comment-form-comment"><textarea id="comment" name="comment" cols="45" rows="7" aria-required="true" class="required"></textarea><span class="required">*</span></p><div class="group"></div>', 'label_submit' => 'Post Review')); ?>
<div class="group"></div>
</div><!-- #comments -->

...
if (!function_exists('header_menu')) :
	function header_menu(){ ?>
           <p style="color:blue;margin:20px 0;font-size:16px;display:inline-block;">Please setup your menu items by going to your Wordpress backend "appearance/menus".</p>
	<?php }
endif;

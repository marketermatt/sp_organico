...
{ 
	$.sp_theme_on_ready = {
		...
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			// search tab
			jQuery("span.tab").toggle(function() {
					jQuery("#search_tab .searchform").stop(true, true).slideDown(200);
				},function(){
					jQuery("#search_tab .searchform").stop(true, true).slideUp(300);
			});
		...
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			// more details fadein on hover for post and products
			jQuery(".product_grid_item .inner_wrap, .post-image-link").hover(function() {
				jQuery(this).find(".more").stop(true, true).fadeIn(300);
			}, function() {
				jQuery(this).find(".more").stop(true, true).fadeOut(300);
			});
		...
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			// cart menu effect
			jQuery("#header_cart .hover-wrap").hoverIntent(function() {
				jQuery("#cartContents").stop(true, true).fadeIn(300);
			}, function() {
				jQuery("#cartContents").stop(true, true).fadeOut(200);
			});
	
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			// footer featured slider
			var changeEvery = parseInt(jQuery(".footer_carousel_interval").val()),
				carouselItems = parseInt(jQuery(".footer_carousel_scroll_items").val()),
				carouselSpeed = parseInt(jQuery(".footer_carousel_speed").val()),
				carouselVisible = parseInt(jQuery(".footer_carousel_visible").val()),
				carouselEasing = jQuery(".footer_carousel_easing").val(),
				carouselCircular = jQuery(".footer_carousel_circular").val(),
				carouselReverse = jQuery(".footer_carousel_reverse").val(),
				carouselEffects = jQuery(".footer_carousel_effects").val(),
				carouselPauseOnHover = jQuery(".footer_carousel_pauseonhover").val(),
				carouselInfinite = jQuery(".footer_carousel_infinite").val(),
				carouselTouchWipe = jQuery(".footer_carousel_touchswipe").val(),
				carouselAutoScrollDirection = jQuery(".footer_carousel_autoscrolldirection").val(),
				prevButton = ".footer_featured .footer-arrow-right",
				nextButton = ".footer_featured .footer-arrow-left";
			if (carouselItems === "") { carouselItems = 1; }
			if (carouselReverse === "true") { 
				var temp = nextButton; 
				nextButton = prevButton;
				prevButton = temp;	
			}
			if (changeEvery === "" || changeEvery === 0) {
				changeEvery = null;	
				var autoplay = false;
			} else {
				changeEvery = changeEvery * 1000;	
			} 
			if (carouselSpeed === '' || carouselSpeed === null) { carouselSpeed = 1000; }
			if (carouselEasing === '' || carouselEasing === '0') { carouselEasing = null; }
			if (carouselVisible !== 0 && carouselVisible !== '' && carouselVisible !== null) {
				jQuery(".footer_featured .footer_slider ul").carouFredSel({
					items: {
					...
					scroll: {
						...
						fx: carouselEffects,
						wipe: carouselTouchWipe
					},
					auto: {
						play: autoplay,
						timeoutDuration: changeEvery	
					},
					next: {
						button: nextButton	
					},
					...
					onCreate: function() {
						jQuery(".footer_featured").css("visibility","visible");	
					}
				});
			}
			...
			// hide the text block between slides
			function onBefore() {
				if (jQuery(window).width() < 960) {
					jQuery("#home-slider .product_description").hide();
				} else {
					jQuery("#home-slider .product_description:visible").fadeOut('fast');
				}	
			}

			// show the text block after slide transitions in
			function onAfter() { 
				if (jQuery(window).width() < 960) {
					jQuery("#home-slider .product_description").hide();
				} else {
					jQuery("#home-slider .product_description").fadeIn(200);
				}
			}
			...
			jQuery("#slides").carouFredSel({
				...
				next: {
					button: '#home-slider span.right-arrow'	
				},
				prev: {
					button: '#home-slider span.left-arrow'
				}				
			});
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			if ( sp_custom.mobile_ready ) {
				...
				function startMobile() {
					if (jQuery(window).width() < 960) {
						...
						jQuery(".footer_slider ul").trigger("configuration", ["direction", function( value ) {
						...
						jQuery("#home-slider .product_description").show();						
					}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			  ...
			  jQuery(".cat-wrap, .wpsc-latest-product, .widget_wpsc_categorisation .wpsc_category_image_link, .portfolio-item, .portfolio-single .image-wrap, .wpcart_gallery .preview_link, .imagecol .preview_link, .footer_slider li").hover(function() {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			// wp ajax logout
			jQuery(".account_logout").live('click',function() {
				jQuery(".header-logout-loading").css("display","block");
				var $spdata = {
				...
				jQuery(".slide2 a.step1").click(function(e){
					...
					jQuery(".slide2").fadeOut('600',function() {
						jQuery(".slide1").fadeIn('300', function() {
							...
							jQuery(".progress_wrapper .info").removeClass('act');
						});
					});						
				});
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

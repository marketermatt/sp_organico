				...
				<tr class="product_view_<?php echo wpsc_the_product_id(); ?> <?php echo $alt_class;?>">
					...
					<?php if(wpsc_show_stock_availability()): ?>	
						...
						<?php if(wpsc_product_has_stock()) : ?>
									<div id="stock_display_<?php echo wpsc_the_product_id(); ?>" class="in_stock"><img src="<?php echo get_template_directory_uri(); ?>/images/instock.png" alt="In Stock" /><?php _e('Product in stock', 'sp'); ?></div>
							<?php else: ?>
									<div id="stock_display_<?php echo wpsc_the_product_id(); ?>" class="out_of_stock"><img src="<?php echo get_template_directory_uri(); ?>/images/outofstock.png" alt="Out of Stock" /><?php _e('Product not in stock', 'sp'); ?></div>
							<?php endif; ?>
						</td>
					<?php endif; ?>
								...
								<?php if(wpsc_product_has_stock()) : ?>
									<div class="wpsc_buy_button_container group">
                                            ...
                                            <?php if (wpsc_have_variation_groups()) { ?>
                                            	<a href="<?php echo wpsc_the_product_permalink(); ?>" title="More Info" class="wpsc_buy_button_link" id="product_<?php echo wpsc_the_product_id(); ?>_submit_button"><?php _e('More Info', 'sp'); ?></a>
											<?php } else { ?>
